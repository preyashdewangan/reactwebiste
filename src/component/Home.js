...
export const Home = () => {
  return (
    <>
    <div class="rk">
      <img className='bg-img' src="https://image1.jdomni.in/banner/12082021/5E/58/D2/63D8488282780ED41670FE276A_1628771140272.jpg?output-format=webp"></img>
      <Container>
        <Row>
          <Col xs={6} md={4}>
          </Col>
          <Col xs={6} md={5}></Col>
          <Col xs={6} md={2}>
            <h1 className="ql ak">Find Your</h1>
            <p className="ql ah">SoulmateHere!</p>
            <button className="ql al">Enquire Now</button>
          </Col>
        </Row>
      </Container>
     </div>
...
/*<img src="https://image3.jdomni.in/banner/12082021/33/C9/A3/B63D8D159012818287F3F730A6_1628769868105.png?output-format=webp" className='kg'/>
          <p class="yow">General Enquiries</p>
        <p class="yov">contact@mysites.com</p>
        
          <img src="https://image2.jdomni.in/banner/12082021/D3/E0/4E/B72756E4920FAB8B4C2D054AEF_1628769879094.png?output-format=webp" className='kg3'/>
          <p class="yow2">Call Us</p>
        <p class="yov2">+91-8888888888</p>
          <img src="https://image3.jdomni.in/banner/12082021/07/E1/76/11D3452A730382447A5B725399_1628769889180.png?output-format=webp" className='kg3'/>
          <p class="yow3">Our Timing</p>
